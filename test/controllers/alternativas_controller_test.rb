...
class AlternativasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alternativa" do
    assert_difference('Alternativa.count') do
      post alternativas_url, params: { alternativa: { codigo: @alternativa.codigo, nome: @alternativa.nome } }
    end
  ...
  test "should update alternativa" do
    patch alternativa_url(@alternativa), params: { alternativa: { codigo: @alternativa.codigo, nome: @alternativa.nome } }
